...
func GetProverbsDailyRange(daysInMonth, currentDay int) ReadingSchedule {
	...
	fmt.Println("isLastDay: ", isLastDay)
...
func GetReadingRanges(dayOfYear int) (ReadingSchedule, ReadingSchedule) {

	OTReading := ReadingSchedule{StartOrdinalVerse: OTReadingIncrements[dayOfYear-1],
		EndOrdinalVerse: OTReadingIncrements[dayOfYear]}

	NTReading := ReadingSchedule{StartOrdinalVerse: NTReadingIncrements[dayOfYear-1],
