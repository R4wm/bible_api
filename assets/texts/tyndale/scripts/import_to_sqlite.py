#!/usr/bin/env python3
"""Import tyndale.txt into SQLite.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import tyndale into SQLite")
    parser.add_argument("--db", required=True, help="Path to SQLite database")
    parser.add_argument("--table", default="tyndale_verses", help="Target table")
