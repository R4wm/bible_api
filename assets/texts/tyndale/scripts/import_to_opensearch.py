#!/usr/bin/env python3
"""Import tyndale.txt into OpenSearch.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import tyndale into OpenSearch")
    parser.add_argument("--url", default="http://localhost:9200", help="OpenSearch URL")
    parser.add_argument("--index", default="tyndale_verses", help="Target index")
