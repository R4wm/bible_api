#!/usr/bin/env python3
"""Import kjv_strongs.txt into SQLite.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import kjv_strongs into SQLite")
    parser.add_argument("--db", required=True, help="Path to SQLite database")
    parser.add_argument("--table", default="kjv_strongs_verses", help="Target table")
