#!/usr/bin/env python3
"""Import net.txt into OpenSearch.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import net into OpenSearch")
    parser.add_argument("--url", default="http://localhost:9200", help="OpenSearch URL")
    parser.add_argument("--index", default="net_verses", help="Target index")
    parser.add_argument("--input", default=str(Path(__file__).resolve().parents[1] / "net.txt"), help="Input text file")
