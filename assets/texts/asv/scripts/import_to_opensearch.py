#!/usr/bin/env python3
"""Import asv.txt into OpenSearch.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import asv into OpenSearch")
    parser.add_argument("--url", default="http://localhost:9200", help="OpenSearch URL")
    parser.add_argument("--index", default="asv_verses", help="Target index")
    parser.add_argument("--input", default=str(Path(__file__).resolve().parents[1] / "asv.txt"), help="Input text file")
