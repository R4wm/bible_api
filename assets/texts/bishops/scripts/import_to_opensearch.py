#!/usr/bin/env python3
"""Import bishops.txt into OpenSearch.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import bishops into OpenSearch")
    parser.add_argument("--url", default="http://localhost:9200", help="OpenSearch URL")
    parser.add_argument("--index", default="bishops_verses", help="Target index")
