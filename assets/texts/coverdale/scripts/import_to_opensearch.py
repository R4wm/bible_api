#!/usr/bin/env python3
"""Import coverdale.txt into OpenSearch.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import coverdale into OpenSearch")
    parser.add_argument("--url", default="http://localhost:9200", help="OpenSearch URL")
    parser.add_argument("--index", default="coverdale_verses", help="Target index")
    parser.add_argument("--input", default=str(Path(__file__).resolve().parents[1] / "coverdale.txt"), help="Input text file")
